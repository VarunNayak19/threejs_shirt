        ...
        <AnimatePresence>
            {!snap.intro && (
                <>
                    ...
                    {/* <div className='z-20 w-40 h-10 glassmorphism absolute bottom-2 right-2 rounded-sm flex justify-center items-center'>
                        <input type="range" name="size" id="size" value={shirtSize} min={1} max={100} step={1}
